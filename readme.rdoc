...
•	Database for Test:
<tt>   create database IcaseiTest_test;</tt>
<tt>   grant all privileges on IcaseiTest_test.* to root@'%' identified by 'password';</tt>

•	Database for Development:
<tt>   create database IcaseiTest;</tt>
<tt>   grant all privileges on IcaseiTest.* to root@'%' identified by 'password';</tt>
